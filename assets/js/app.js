...
async function init(){
  ...
  document.getElementById("models").innerHTML=models.map(x=>`<div class="model"><strong>✓ ${x}</strong><span>Flexible engagement aligned with your requirement.</span></div>`).join("");
